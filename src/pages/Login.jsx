      ...
      signInWithEmailAndPassword(auth, temail, tpass)
        .then((userCredential) => {
          ...
          .then((response) => {
            ...
            console.log("Expected user data from backend:", userData);
  
           
            console.log("Inputted credentials:", { tuser, temail, tpass });
  
            
            localStorage.setItem("userId", userData._id);
  

            console.log("Comparing _id:", userData._id === response.data.user._id);
            console.log("Comparing userName:", userData.userName === tuser);
            console.log("Comparing password:", userData.password === tpass);
            console.log("Comparing emailId (case-insensitive):", userData.emailId.toLowerCase() === temail.toLowerCase());
            ...
            if (
              ...
              userData.emailId.toLowerCase() === temail.toLowerCase() 
            ) {
